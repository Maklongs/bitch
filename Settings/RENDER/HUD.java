...
public class HUD extends Mod
{
    ...
    public void onRender2D(final EventRender2D class112) {
        ...
        final StringBuilder append = new StringBuilder().append("\247b").append("X:¡ìr ").append((int)this.mc.thePlayer.posX).append("\247b").append(" Y:¡ìr ").append((int)this.mc.thePlayer.posY).append("\247b").append(" Z:¡ìr ").append((int)this.mc.thePlayer.posZ).append("\247b").append(" FPS:¡ìr ");
        final Minecraft mc = this.mc;
        final String string = append.append(Minecraft.getDebugFPS()).append("\247b").append(" TPS: ¡ìr").append((int)this.lastTps).toString();
    ...
    public void renderPotionStatus(final float n, final float n2) {
        ...
        for (final PotionEffect p_getDurationString_0_ : this.mc.thePlayer.getActivePotionEffects()) {
            ...
            Client.instance.fontMgr.wqy16.drawString(s.split("\2473")[1], n - 101.0f, n7 - this.mc.fontRendererObj.FONT_HEIGHT, new Color(47, 116, 253).getRGB());
